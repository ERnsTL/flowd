...
// edges
pub type ProcessEdge = rtrb::RingBuffer<FbpMessage>;
pub type ProcessEdgeSource = rtrb::Consumer<FbpMessage>;
pub type ProcessEdgeSinkConnection = rtrb::Producer<FbpMessage>;
